...
def eh_bissexto(ano):
    ...
    # Método 1: Usando módulo calendar
    return calendar.isleap(ano)
#print(ano)

ano = eh_bissexto()
#Verifica se a idade foi digitada em das ou anos e partir disso, calculá quantos anos a pessoa tem
if inputIdadeAnos > 150:
    print("Falso Idoso, para de mentir, coloque os dados corretamente.")
    perguntas()
elif "M" in tipoIdade:
    idadeAnos = inputIdade / 12
elif "D" in tipoIdade #pegar a idade em anons, calcular idadeAnos MAIS 1 ano e gerar um for com indice
#colocar um laço de repetição
    if "D" in tipoIdade and inpuIdadeDias % 1:
        idadeAnos = inputIdade / 365
    elif "D" in tipoIdade and inpuIdadeDias % ano % 2 == 0 and ano % 4 == 0 or ano % 400 == 0:
        idadeAnosB = inputIdade / 366
    ####################
idadediasemanos  = idadeAnos + idadeAnosB
elif "A" in tipoIdade:
